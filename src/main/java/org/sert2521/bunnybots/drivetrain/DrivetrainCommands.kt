...
suspend fun followPath(path: Path2D, extraTime: Double = 0.0, useLidar: Boolean = false, forward: Boolean = true) = use(Drivetrain) {
    Drivetrain.driveAlongPath(path, extraTime, useLidar, forward)
}
